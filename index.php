...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $messages = [
            ...
            'delete_entry' => t('entry_deleted'), 'edit_entry' => t('entry_updated'), 'continue_entry' => t('timer_reopened'), 'set_billed' => t('billing_status_updated'), 'delete_project' => t('project_deleted'),
